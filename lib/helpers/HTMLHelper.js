  ...
  static newTableRow(meal, val){
    return `
      <tr class='table-row'>
        ...
        <td class='${meal.name}-calories table-cal ${val['id']}'>${val['calories']}</td>
        <td class='delete-button'><input type='image' class='delete-food ${val['id']} meal ${meal.id} ' src='https://i.imgur.com/Ea2X1B0.png'/ alt='delete button'></td>
      </tr>`
  }
}
