...
function appendMealTotals() {
  ...
  mealTotalsTable.append('<tr> <td>Goal Calories</td> <td>2000</td> </tr>')
  mealTotalsTable.append('<tr> <td>Calories Consumed</td> <td id="all-cals-consumed">CALORIESCONSUMED</td> </tr>')
  mealTotalsTable.append('<tr> <td>Remaining Calories</td> <td>REMAININGCALORIES</td> </tr>')
}
