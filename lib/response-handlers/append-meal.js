...
function appendMealTotals() {
  ...
  mealTotalsTable.append('<tr> <td>Goal Calories</td> <td id="total-meal-cals">2000</td> </tr>')
  mealTotalsTable.append('<tr> <td>Calories Consumed</td> <td>CALORIESCONSUMED</td> </tr>')
