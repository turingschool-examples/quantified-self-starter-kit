...
function getAllFoods() {
  fetch('https://turing-quantified-self-api.herokuapp.com/api/v1/foods').then(function (response) {
    return response.json();
  }).then(function (data) {
    data.forEach(function (food) {
      $('table').append('<tr><td>' + food.name + '</td><td>' + food.calories + '</td><td><img src=\'../assets/delete1.png\'></td></tr>');
