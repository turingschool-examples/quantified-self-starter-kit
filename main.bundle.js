	  ...
	  _createClass(FoodService, [{
	    ...
	    value: function getAllFoods() {
	      ...
	      fetch(API + 'foods').then(function (response) {
	        ...
	        data.forEach(function (food) {
	          _this.addFood(food.id, food.name, food.calories);
	        });
	      });
	    }
	  }, {
	    ...
	    value: function sendPostRequest(name, calories) {
	      ...
	      fetch(API + 'foods', {
	        ...
	        return _this2.addFood(data.id, data.name, data.calories, false);
	      });
	    }
	  }, {
	    key: 'editBox',
	    ...
	    value: function editFood(id, attr) {
	      ...
	      fetch(API + 'foods/' + id.toString(), {
	        ...
	        _this4.addFood(data['id'], data['name'], data['calories']);
	      });
	    }
	  }, {
	    key: 'displayWith',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var $ = __webpack_require__(1);
	var MealService = __webpack_require__(6);
	var FoodService = __webpack_require__(3);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var MealService = function () {
	  ...
	  _createClass(MealService, [{
	      ...
	      fetch(API + 'meals').then(function (response) {
	        ...
	        data.forEach(function (table) {
	          ...
	          table["foods"].forEach(function (food) {
	            _this.addFood(food["id"], food["name"], food["calories"], table["id"]);
	          });
	          _this.addTotalCalories(table["id"]);
	        });
	      }).then(function (data) {
	    ...
	    key: 'addFood',
	    value: function addFood(id, name, calories, mealId) {
	    ...
	    value: function remainingCalories(id, total) {
	      if (id === 2) {
	        return 200 - total;
	      } else if (id === 1) {
	        return 400 - total;
	    ...
	    value: function postFood(mealId, foodId) {
	      ...
	      fetch(API + ('meals/' + mealId + '/foods/' + foodId), {
	        ...
	        _this3.addinfo(mealId, $name, $calories, $newRow);
	      });
	    }
	  }]);
